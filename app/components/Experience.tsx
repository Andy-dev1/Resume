      ...
      <div className="  container max-w-[1160px] mx-auto">
        <div className="flex">
          <div className="h-[710px]">
            <div className="w-[268px] h-[60%] border-4 border-black ps-[34px] py-[19px]">
            ...
            <div className="w-[268px] bg-blue-400 h-[40%] border-b-4 border-black border-x-4"></div>
          </div>
          <div className="h-[710px]">
            <div className="pe-28 w-[892px] h-[80%] border-y-4 border-r-4 border-black ps-[34px] py-[19px]">
              <h4 className="font-bold text-2xl mb-5">Experiência</h4>
              <div className="mb-4">
                ...
                <p className="ms-7 mt-1 text-base">
            ...
            <div className="h-[20%] border-b-4 border-r-4 border-black">
                <h1 className="font-black text-[148px] leading-none text-stroke-3 text-[#DDDCDA] ">PROGRESS</h1>
            </div>
          </div>
        </div>
      </div>
